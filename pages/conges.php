  ...
  <div class="row g-3 mb-0 mt-0 align-items-center justify-content-between">
                  ...
                  <div class="col-auto ">						    
                      <button class="btn app-btn-primary " data-toggle="modal" data-target="#ajouterModal">
                          <i class="fas fa-plus"></i> Demandez
                      </button>
                  </div>
						    </div><!--//row-->
					    </div><!--//table-utilities-->
    ...
    <div  class="panel-heading mb-4" style=" display: inline-block;width: 500px;height: 10px;color:#000;font-size:xx-large;"> Listes de mes congés</div>
    <div class="panel-body mt-4">
       <form method="get" action="congesRH.php">
        ...
        <thead class="tablecolor thead-light">
         <tr>
            <th style="font-size:14px;text-transform: none;">Type</th>
            <th style="font-size:14px;text-transform: none;">Date debut</th>
            <th style="font-size:14px;text-transform: none;">Date fin</th>
            <th style="font-size:14px;text-transform: none;">Période</th>
            <th style="font-size:14px;text-transform: none;">Jours consommés</th>
            <th style="font-size:14px;text-transform: none;">Jours restants</th>
            <th style="font-size:14px;text-transform: none;">Statut</th>
            <th style="font-size:14px;text-transform: none;">Action</th>
            </tr> 
        </thead >
        <tbody>
            ...
            <td ><?php echo $conges['nombre'] ?></td>
            <!-- <td ><?php $nbjours = round((strtotime($conges['datefin']) - strtotime($conges['datedebut']))/(60*60*24));echo $nbjours .' jours';?></td> -->
            ...
            <td class="cell">
                <a onclick="return confirm('Etes vous sûr de vouloir supprimer la formation')" 
														href="supprimerconge.php?idconge=<?php echo $conges['idconge']?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- Contenu du formulaire de demande de congé -->
        <?php include('demandeconges.php'); ?>
      </div>
