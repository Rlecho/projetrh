  ...
  <body>
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-center">Modifier l'annonce</h5>
                    <form method="post" action="modificationannonce.php">
                        <div class="mb-3">
                            <input type="hidden" name="id" value="<?php echo $idannonce ?>">
                            <label for="titre" class="form-label">Titre</label>
                            <input type="text" name="titre" class="form-control" id="titre" value="<?php echo $titreA ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea class="form-control" name="t1" id="mytextarea" rows="6" required><?php echo $descriptionA ?></textarea>
                        </div>
