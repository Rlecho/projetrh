...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 29 fév. 2024 à 11:07
...
INSERT INTO `conges` (`idconge`, `datecreation`, `periode`, `datedebut`, `datefin`, `typeconge`, `motif`, `nom`, `idemp`) VALUES
(30, '2024-02-23', 8, '2024-02-29', '2024-03-08', 'Arrêt Maladie', 'Non rien', 'akoba', 69);
...
(84, 'SDFGH', 'Réunion externe', '2024-02-29', '13:19:00'),
(85, 'SDFGH', 'Réunion externe', '2024-02-14', '16:50:00'),
(86, 'SDFGHszedfgh', 'Réunion externe', '2024-02-14', '16:50:00'),
(87, 'cvb', 'Réunion interne', '2024-02-28', '22:09:00'),
(88, 'cvbn', 'Réunion interne', '2024-02-28', '17:04:00'),
(89, 'cvbn', 'Réunion interne', '2024-02-28', '17:04:00');
...
--
ALTER TABLE `congesdemandes`
  MODIFY `idconge` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `reunion`
  MODIFY `idreunion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
